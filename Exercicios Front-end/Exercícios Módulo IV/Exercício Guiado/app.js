...
// =====================================================================================
    // IF DE FORMA ENCURTADA, MESMA COISA QUE O DE CIMA!! 👆
...
btnSalvar.addEventListener('click', () => {
    ...
    if(novoNome == ''){
        alert('Tongão!, O nome não pode estar vazio! Boca berta!');
        return;
    }

    nomeUsuario.textContent = novoNome;
    profissaoUsuario.textContent = novaProfissao || 'Sem porfissão';
